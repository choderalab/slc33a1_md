...
"""
Script name: slc33a1_gssg_sim_continue.py

Purpose: Continue a simulation from a checkpoint file
"""
...
with open('sim_params_contd.yaml') as file: # Load YAML containing location of projects
...
checkpoint_filename = 'output.chk'
